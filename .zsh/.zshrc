...
export PATH="$HOME/.local/bin:$HOME/.poetry/bin:/opt/homebrew/opt/rustup/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin"
...
# Use sloppy mode by default, m#atching web browsers.
...
alias ls='gls --color -h --group-directories-first -F -a'
...
#_# See `.completions` file for all the list of fast tab completions.
